...
export default function Nav({show}) {
  ...
  return (
    <aside 
    className={(show?'left-0':'-left-full')+" mb-0  top-0 text-white p-4 fixed w-full bg-bgAdmin h-screen md:sticky md:w-auto transition-all flex flex-col"}
    // className="fixed bg-bgAdmin top-0 text-white p-4 w-full md:w-auto h-full transition-all left-0 -left-full"
    >
      ...
      <div className="border-b  border-white mb-7  w-1x "></div>
      <nav className="flex flex-col flex-grow gap-6 ">
      ...
      <div className="hidden sm:block ">
        <div className="bg-white px-3 py-3 flex gap-1 text-bgText rounded-lg overflow-hidden justify-center">
